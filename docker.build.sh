...
docker tag secure.es.proxy "registry.ferrumdome.com/ferrumgate/secure.es.proxy:$version"
docker tag secure.es.proxy registry.ferrumdome.com/ferrumgate/secure.es.proxy:latest
docker tag secure.es.proxy "ferrumgate/secure.es.proxy:$version"

execute() {
    docker push registry.ferrumdome.com/ferrumgate/secure.es.proxy:"$version"
    docker push registry.ferrumdome.com/ferrumgate/secure.es.proxy:latest
